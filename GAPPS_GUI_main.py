...
# separator4.grid(row=26, column=0, columnspan=4, sticky='ew', pady=10)
...
#space_04 = tk.Label(root, text=" ", font=("Arial", 10, "bold")
...
copyright_label.grid(row=40, column=0, columnspan=3, sticky='s')
