...
root.geometry("800x950")  # Set window size (width x height)
...
label_01 = tk.Label(root, text="   Tool 1 – Airphoto Canvas Sizing", font=("Arial", 16, "bold"), fg='black')
...
# --------------------------------------
    ...
    # Main label
label_02 = tk.Label(root, text="   Tool 2 – Fiducial Mark (FM) Detection", font=("Arial", 16, "bold"), fg='black')
label_02.grid(row=4, column=0, columnspan=3, pady=5, sticky='w')

        # Sub-label 1
label_02a = tk.Label(root, text="         2.1. Select or create the new camera model", font=("Arial", 14, "italic"), fg='black')
label_02a.grid(row=5, column=0, columnspan=3, pady=5, sticky='w')
...
entry_camera.grid(row=7, column=0)
...
refresh_button.grid(row=8, column=0, pady=5)
...
add_camera_button = tk.Button(root, text="Add new camera model...", font=("Arial", 14, "bold"), fg='black', command=launch_add_camera_gui)
add_camera_button.grid(row=7, column=2, sticky='w')

        # Sub-label 2
label_02b = tk.Label(root, text="         2.2. Create the FM templates", font=("Arial", 14, "italic"), fg='black')
label_02b.grid(row=9, column=0, columnspan=3, pady=10, sticky='w')
...
button_template_folder.grid(row=14, column=3, sticky='w')

        # P-value selection
pValue_label = tk.Label(root, text="P-value:", font=("Arial", 12), fg='black')
pValue_label.grid(row=15, column=0)
...
entry_stripe.grid(row=16, column=1)
...
auto_FM_detection_button = tk.Button(root, text="Run automatic FM detection", font=("Arial", 14, "bold"), command=auto_FM_detection, fg='black', width=25, height=1)
auto_FM_detection_button.grid(row=15, column=2)
...
separator2.grid(row=17, column=0, columnspan=3, sticky='ew', pady=15)

# 2.4. Tool 3 – Image Reprojection
# ---------------------------------

    # Main label
label_03 = tk.Label(root, text="   Tool 3 – Image Reprojection", font=("Arial", 16, "bold"), fg='black')
label_03.grid(row=18, column=0, columnspan=1, pady=5, sticky='w')
...
button_03 = tk.Button(root, text="Launch Image Reprojection", font=("Arial", 14, "bold"), command=reproject_image, fg='black', width=25, height=1)
button_03.grid(row=19, column=0)
...
# ----------------------------------------------
    ...
    # Main label
label_04 = tk.Label(root, text="   Tool 4 – Image Resampling and Sharpening", font=("Arial", 16, "bold"), fg='black')
label_04.grid(row=18, column=1, columnspan=2, pady=5, sticky='w')
...
input_resol_label.grid(row=19, column=1)
...
entry_intensity.grid(row=22, column=2)
...
button_04 = tk.Button(root, text="Run Resampling/Sharpening", font=("Arial", 14, "bold"), command=im_resampling_sharpening, fg='black', width=25, height=1)
button_04.grid(row=23, column=1)

    # Create a horizontal separator
separator4 = ttk.Separator(root, orient='horizontal')
separator4.grid(row=24, column=0, columnspan=3, sticky='ew', pady=10)
#space_04 = tk.Label(root, text=" ", font=("Arial", 14, "bold"))
...
# ----------------------------
    ...
    # Main label
label_05 = tk.Label(root, text="   Tool 5 – Image Masking", font=("Arial", 16, "bold"), fg='black')
label_05.grid(row=25, column=0, columnspan=3, pady=5, sticky='w')

    # entry titles
entry_x_title = tk.Label(root, text="% in X", font=("Arial", 12), fg='black')
entry_x_title.grid(row=26, column=0)

entry_y_title = tk.Label(root, text="% in Y", font=("Arial", 12), fg='black')
entry_y_title.grid(row=26, column=1)

    # entry fields
entry_x = tk.Entry(root)
entry_x.grid(row=27, column=0)

entry_y = tk.Entry(root)
entry_y.grid(row=27, column=1)
...
mask_button = tk.Button(root, text="Create mask", font=("Arial", 14, "bold"), command=masking, fg='black', width=25, height=1)
mask_button.grid(row=27, column=2)
...
copyright_label.grid(row=32, column=0, columnspan=3, sticky='s')
