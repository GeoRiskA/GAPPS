...
def image_masking(input_image_folder,output_mask_folder,dataset_name,percent_mask_size_X=12,percent_mask_size_Y=12,image_format = '*.tif'):
    print(' ')
    print('=====================================================================')
...
if __name__ =='__main__':
    image_masking(input_image_folder,output_mask_folder,dataset_name,percent_mask_size_X,percent_mask_size_Y,image_format = '*.tif')